...
namespace ECS
{
    ...
    namespace Systems
    {
        ...
        private:
            ...
            static void HandleCreatureDeinitialization(World& world, Scripting::Zenith* zenith, Singletons::TimeState& timeState, Singletons::GameCache& gameCache, Singletons::NetworkState& networkState);
            static void HandleCreatureInitialization(World& world, Scripting::Zenith* zenith, Singletons::TimeState& timeState, Singletons::GameCache& gameCache, Singletons::NetworkState& networkState);
            ...
            static void HandleCombatTimeoutUpdate(World& world, Scripting::Zenith* zenith, Singletons::TimeState& timeState);
