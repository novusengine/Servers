...
namespace ECS
{
    ...
    namespace Util::Persistence::Character
    {
        ...
        ECS::Result ItemAdd(Singletons::GameCache& gameCache, entt::registry& registry, entt::entity characterEntity,
            ...
            u64& itemInstanceID, Database::OperationFailure* databaseFailure = nullptr);
        ECS::Result ItemDelete(Singletons::GameCache& gameCache, entt::registry& registry, entt::entity characterEntity,
            ...
            Database::OperationFailure* databaseFailure = nullptr);
        ECS::Result ItemSwap(Singletons::GameCache& gameCache, u64 characterID, Database::Container& srcContainer,
            ...
            u16 dstSlotIndex, Database::OperationFailure* databaseFailure = nullptr);
    }
}
